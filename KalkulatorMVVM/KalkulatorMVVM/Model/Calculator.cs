...
namespace KalkulatorMVVM.Model
{
    using Operations;
    class Calculator
    {
        ...
        public string[] Symbols
        {
            get
            {
                if (Operations.Count == 0)
                    throw new Exception("Nie zdefiniowano, żednych operacji");
        ...
        public decimal ExceuteOperation(string symbol, decimal firstArg, decimal
                        secondArg)
        {
        ...
        public decimal Calculate(Operations.IOperation operation, decimal firstArg,
        decimal secondArg)
        {
